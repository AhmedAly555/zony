          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    final success = await openInGoogleMaps(
                      latitude: pudo.coordinates.latitude,
                      longitude: pudo.coordinates.longitude,
                    );

                    if (!success && context.mounted) {
                      showErrorToast(message: 'Failed to open map');
                    }
                  },
                    ...
                    children: [
                      Expanded(
                        child: InfoItem(
                          ...
                          text: pudo.address?? S.of(context).noAddressFound,
                        ),
                      ),
