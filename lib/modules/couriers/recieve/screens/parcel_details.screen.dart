...
import 'successful_recieve.screen.dart';
...
class _ParcelDetailsScreenState extends State<ParcelDetailsScreen> {
  ...
  Future<void> _fetchParcelDetails() async {
    try {
      ...
      showErrorToast(message: S
          .of(context)
          .failedToFetchParcelDetails + '$e');
  ...
  Future<void> _handleParcelConfirmation({
    ...
    try {
      ...
      await ParcelImageService.instance.createSignedUrl(
        parcelId: parcelId,
        imageType: ParcelImageType.warehouseImage.apiValue,
      );
      ...
      showCorrectToast(message: S
          .of(context)
          .parcelReceivedSuccessfully);
