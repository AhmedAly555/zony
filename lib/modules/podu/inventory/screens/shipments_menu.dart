...
class ShipmentsMenuScreen extends StatefulWidget {

  final String pudoId;

   const ShipmentsMenuScreen({super.key, required this.pudoId});

  @override
  State<ShipmentsMenuScreen> createState() => _ShipmentsMenuScreenState();
}

class _ShipmentsMenuScreenState extends State<ShipmentsMenuScreen> {
  ...
  Widget build(BuildContext context) {
    return TemplateAppScaffold(
      body: Padding(
        ...
        child: Column(
          children: [
            SecondaryAppBar(title: 'Ready to Deliver'),
            SizedBox(height: 28),
            //search container
            Container(
